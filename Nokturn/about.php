			...
			<div class="content">
				<div class="row">
					<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
						<img src="img/left.jpg" style="width: 90%; height: 400px;" class="img-responsive img-thumbnail"/>
					</div>
					<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 visible">
						<img src="img/right.jpg" style="width: 90%; height: 400px;" class="img-responsive img-thumbnail"/>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div class="about-text">
							<h2>About us</h2>
							<p>Hello, we are <span style="font-size: 24px; color: #5282E0;">Magda and Lucas</span> - students from Wroclaw, Poland. We study computer science on faculty of Electronics for over 2 years. This online shop is our assignment for a Database course. You can check our <span style="font-size: 24px; color: #5282E0;">Github page :)</span></p>
						</div>
					</div>
					...
					<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
						<div class="about-text">
							<h2>About project</h2>
							<p>This online shop is our assignment for a Database course. We tried to use as many techniques as we could. This website contains use of <span style="font-size: 24px; color: #5282E0;">Twitter Bootstrap</span>, snippets from websites, JQuery shopping cart and a lot of hard work. We also did this project using <span style="font-size: 24px; color: #5282E0;">Git</span> and uploading our work to Github :)</p>
						</div>
					</div>
				</div>
			</div>
